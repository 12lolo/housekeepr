...
@section('content')
    <div class="neu-widget">
        <div class="widget-header">
            ...
            <a href="{{ route('owner.bookings.create') }}" class="neu-button-primary">
        ...
        <div class="widget-body">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $booking->cleaningTask?->cleaner?->user?->name ?? '-' }}</td>
                                <td>
                                    @if($booking->cleaningTask)
                                        ...
                                        @endif
                                    @else
                                        <span class="neu-badge">Geen taak</span>
                                    @endif
                                </td>
                                <td class="table-actions">
                                    <a href="{{ route('owner.bookings.show', $booking) }}" class="action-btn" aria-label="Bekijken">
                                        <svg width="16" height="16" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"/>
                                            <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd"/>
                                        </svg>
                                    </a>
                                    <a href="{{ route('owner.bookings.edit', $booking) }}" class="action-btn" aria-label="Bewerken">
                                        <svg width="16" height="16" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"/>
                                        </svg>
                                    </a>
                                    <form action="{{ route('owner.bookings.destroy', $booking) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="action-btn danger" aria-label="Verwijderen" onclick="return confirm('Weet je zeker dat je deze boeking wilt verwijderen?')">
                                            <svg width="16" height="16" fill="currentColor" viewBox="0 0 20 20">
            ...
            @else
                <div class="neu-empty-state">
                    ...
                    <div class="empty-title">Geen boekingen</div>
                    <div class="empty-message">Voeg een nieuwe boeking toe om te beginnen</div>
                </div>
            @endif
        </div>
    </div>
