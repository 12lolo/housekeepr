...
@section('page-title', 'Nieuwe Boeking')
            ...
            <form action="{{ route('owner.bookings.store') }}" method="POST">
                ...
                <div class="neu-form-group">
                    ...
                    <input
                        ...
                        value="{{ old('check_in_datetime') }}"
                        required
                    >
                    @error('check_in_datetime')
                        <span class="neu-error">{{ $message }}</span>
                    @enderror
                    <small class="neu-hint">Moet in de toekomst liggen. Schoonmaaktaak wordt automatisch gepland.</small>
                </div>
