        ...
        <div class="neu-modal-body">
            <form action="{{ route('owner.bookings.store') }}" method="POST" id="bookingCreateForm">
                ...
                <div class="neu-modal-footer">
                    <button type="button" class="neu-button-secondary" onclick="closeModal('bookingCreateModal')">Annuleren</button>
                    <button type="submit" class="neu-button-primary">Boeking toevoegen</button>
                </div>
            </form>
        </div>
    </div>
